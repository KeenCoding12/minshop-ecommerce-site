...
export default function HeaderClient() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Search bar */}
      {searchOpen && (
        <div className="border-t border-gray-700 px-4 sm:px-6 lg:px-8 py-3">
          <div className="max-w-7xl mx-auto">
            <input
              type="text"
              placeholder="Search products..."
              autoFocus
              className="w-full bg-gray-800 text-white placeholder-gray-400 rounded-md px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
      )}
